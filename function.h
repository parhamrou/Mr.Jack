...
{ 
    ...
    scanf("%d", &choose);
    map_printer();
    card_delete(choose, 3, &odd_round_head); 
    ...
    scanf("%d", &choose);
    map_printer();
    card_delete(choose, 0, &odd_round_head); 
    search_character(choose);
    turn_counter = 1;
    return 0;
}
int even_round()
{
    ...
    scanf("%d", &choose);
    map_printer();
    card_delete(choose, 3, &even_round_head); 
    search_character(choose);               
    if (game_over == 1)
    {
        turn_counter = 1;
    ...
    scanf("%d", &choose);
    map_printer();
    card_delete(choose, 0, &even_round_head);
    search_character(choose);
    turn_counter = 1;
